...
class InteractiveCube(plt.Axes):
    ...
    def _initialize_widgets(self):
        ...
        self._ax_shuffle = self.figure.add_axes([0.8, 0.9, 0.2, 0.075])
    ...
    def _shuffle_cube(self, *args):
        print("Suffle")
        cube_scrambled,scramble_instructions,solution = generate_game(max_moves = 6)
...
if __name__ == '__main__':
    ...
    model = load_model('tmp_conv3D_6000_32.h5')
